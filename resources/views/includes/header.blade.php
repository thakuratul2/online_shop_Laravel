<!--
	...
	Date : 10/07/2023
	Desc : Online E-commernce Website for major project
	--->
<!DOCTYPE html>
<html class="no-js" lang="en_AU" />
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<title>Welcome | Atul Shop</title>
		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="{{url('/')}}" class="text-decoration-none">
					<span class="h1 text-uppercase text-primary bg-dark px-2">Atul's</span>
					<span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">SHOP</span>
				</a>
			</div>
			<div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
				<a href="{{route('login.page')}}" class="nav-link text-dark">Login</a>
				<a href="{{route('register.page')}}" class="nav-link text-dark">Register</a>
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="{{url('/')}}" class="text-decoration-none mobile-logo">
				<span class="h2 text-uppercase text-primary bg-dark">Atul's</span>
			...
			<div class="right-nav py-0">
				<a href="{{route('cart.page')}}" class="ml-3 d-flex pt-2">
