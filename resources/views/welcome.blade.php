        ...
        <div class="container">
            ...
            <div class="row pb-3">
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            <img src="{{asset('frontend-asset/images/cat-1.jpg')}}" alt="" class="img-fluid">
                        </div>
                        <div class="right">
                            <div class="cat-data">
                                <h2>Mens</h2>
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="{{route('product.page')}}" class="product-img"><img class="card-img-top" src="{{asset('frontend-asset/images/product-1.jpg')}}" alt=""></a>
                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="" class="product-img"><img class="card-img-top" src="{{asset('frontend-asset/images/product-1.jpg')}}" alt=""></a>
                            <a class="whishlist" href="222"><i class="far fa-heart"></i></a>                            
